    ...
    return (
        <>
            ...
            <div>
                   ...
                   //  (lastLocation.pathname === 123 || (lastLocation.pathname && lastLocation.pathname.substr(0,8) === "/details")) &&
                    <div>
                        <ul>
                            ...
                            {
                                (!lastLocation || (lastLocation && lastLocation.pathname && lastLocation.pathname.substr(0,8) === "/details")) && userId  && (userType === "user") &&
                ...
                {
                    (!edited && (userType === "user")) && ((lastLocation && lastLocation.pathname && !lastLocation.pathname.substr(0,8) !== "/details") || !lastLocation)  && !userId &&
                ...
                {
                    (!edited && (userType === "admin")) && ((lastLocation && lastLocation.pathname && !lastLocation.pathname.substr(0,8) !== "/details") || !lastLocation)  &&
                    // !edited && (userType === "user" || userType === "admin") && !userId &&
                    // !edited && (userType === "user" || userType === "admin") && lastLocation && lastLocation.pathname && lastLocation.pathname.substr(0,8) !== "/details" &&
                    <>
                        {/*<h4>dsad</h4>*/}
